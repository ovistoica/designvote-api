...
-- design_option
truncate table design_option cascade;
insert into design_option (option_id, design_id, name, description, votes )
...
insert into picture ( picture_id,option_id, "uri")
...
insert into vote (option_id, opinion)
